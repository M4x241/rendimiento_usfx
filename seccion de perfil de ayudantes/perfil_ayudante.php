...
function obtenerPerfilAyudante()
{
    ...
    // Obtener información del ayudante
    ...
    // Obtener comentarios del ayudante
    $sqlComentarios = "
        SELECT * FROM comentarios_ayudantes 
...
function agregarComentario()
{
    ...
    $sql = "
        ...
        VALUES($id_ayudante, '$nombre_estudiante', '$email_estudiante', '$comentario', $calificacion)
    ";
