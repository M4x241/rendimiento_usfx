...
<div class="layout">
    <aside class="sidebar">
        ...
        <a href="php/logout.php" class="menu-item salir">Cerrar sesion</a>
    </aside>
    <main class="contenido">
        <div class="topbar">
            <div>
                <h2>Configuracion de perfil</h2>
                <p>Administra tus datos personales dentro del sistema academico.</p>
            </div>
        </div>
            ...
            <div class="col-lg-4">
                <div class="card perfil-card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <hr>
                        <p class="small text-muted mb-0">Informacion obtenida desde MySQL usando PHP, Fetch y JSON.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-white"><strong>Editar informacion del usuario</strong></div>
                    <div class="card-body">
                        <form id="formPerfil">
                            <div class="row">
